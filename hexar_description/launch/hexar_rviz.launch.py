...
def generate_launch_description():
    package_share_path = get_package_share_path("hexar_description")
    default_model_path = str(package_share_path / "urdf/hexar.urdf")
    default_rviz_config_path = str(package_share_path / "rviz/hexar.rviz")
